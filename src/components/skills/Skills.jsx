  ...
  return (
    <Animation>
      <section
        id="skills"
        ref={ref}
        className="w-full min-h-screen dark:text-slate-500"
      >
        ...
        <div className="w-full">
          ...
          <div className="w-full py-4">
            <Header
              ...
              marginY3X={true}
            />
            <div className="flex gap-6 flex-wrap w-[80%] mx-auto">
              {SKILLS.map((skill, idx) => (
                ...
                >
                  <div
                    ...
                    className="w-full h-full flex justify-center items-center bg-white dark:bg-[#19282F] p-2"
                  >
                    <img
                      id="skill_img"
                      style={{
