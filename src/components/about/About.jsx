      ...
      >
        ...
        <div className="flex items-center flex-wrap p-5">
          <div className="w-full lg:w-2/5 py-3 flex justify-center items-center overflow-hidden">
            ...
            >
              <img
                src="https://plus.unsplash.com/premium_photo-1682600101311-1121bc732450?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
                className="w-full rounded-lg duration-100"
              />
            </motion.div>
          </div>

          <motion.p
            className="w-full lg:w-2/5 mb-5 md:mb-0 p-4 md:p-3 break-words"
            variants={variantLeft}
          >
              ...
              {state.exp?.length > 0 &&
                ...
                flex justify-center items-center"
                            ...
                            >
                              ...
                              adipisicing elit. Quos impedit dignissimos labore,
                              nobis beatae exercitationem?
                            </span>
                          </div>
                        )}
                        {about.other &&
                          about.other.split(",").map((oth, ind) => (
                            <div
                              key={ind}
                              className="flex mt-3 justify-start items-center gap-1 bg-[#16213E]  rounded-lg text-[#ABD9FF] p-2 dark:drop-shadow-light"
                            >
                              <span
                                style={{
                                  fontSize: "12px",
                ...
                flex justify-center items-center"
                              ...
                              >
                                {/* {oth} */}
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Recusandae, nobis?
                              </span>
                            </div>
                          ))}
                        {about.work && (
                ...
                flex justify-center items-center"
                            ...
                            <span
                              ...
                              className="break-word inline-block"
                            >
                              {/* {about.work} */}
